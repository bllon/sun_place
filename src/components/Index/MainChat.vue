      ...
      <ul class="list-unstyled">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          ...
          <div class="avatar status-offline">
            <img class="avatar-img rounded-circle" src="static/images/avatar/placeholder.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar">
            <img class="avatar-img rounded-circle" src="static/images/avatar/04.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          ...
          <div class="avatar avatar-story status-online">
            <img class="avatar-img rounded-circle" src="static/images/avatar/05.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar status-online">
            <img class="avatar-img rounded-circle" src="static/images/avatar/06.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          ...
          <div class="flex-shrink-0 avatar">
            <ul class="avatar-group avatar-group-four">
              ...
              <li class="avatar avatar-xxs">
                <img class="avatar-img rounded-circle" src="static/images/avatar/08.jpg" alt="avatar">
              </li>
              <li class="avatar avatar-xxs">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar status-offline">
            <img class="avatar-img rounded-circle" src="static/images/avatar/08.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar">
            <img class="avatar-img rounded-circle" src="static/images/avatar/09.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar status-online">
            <img class="avatar-img rounded-circle" src="static/images/avatar/10.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar">
            <img class="avatar-img rounded-circle" src="static/images/avatar/11.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
        ...
        <li class="mt-3 hstack gap-3 align-items-center position-relative">
          <!-- Avatar -->
          <div class="avatar status-online">
            <img class="avatar-img rounded-circle" src="static/images/avatar/12.jpg" alt="">
          </div>
          <!-- Info -->
          <div class="overflow-hidden">
