    ...
    <div class="modal-content">
      ...
      <!-- Modal feed header END -->
        ...
        <div>
          ...
          <div class="dropzone dropzone-default card shadow-none" data-dropzone='{"maxFiles":2, "url":"/file/post"}'>
...
export default {
  ...
  mounted() {
    // console.log("初始化拖拽上传");
    var el = document.querySelector("[data-dropzone]");
    // console.log(el);
		if (typeof !!el && (el) != 'undefined' && el != null) {
      // console.log(111);
			window.Dropzone.autoDiscover = false;

			// 1. Default Dropzone Initialization
      el = document.querySelector(".dropzone-default");
			if (typeof !!el && (el) != 'undefined' && el != null) {
				document.querySelectorAll(".dropzone-default").forEach((e => {
          // console.log(e.dataset.dropzone);
      ...
      el = document.querySelector(".dropzone-custom");
			if (typeof !!el && (el) != 'undefined' && el != null) {
				document.querySelectorAll(".dropzone-custom").forEach((d => {
          // console.log(e.dataset.dropzone);
